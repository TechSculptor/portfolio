...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $password = $_POST['password']; // Password usually shouldn't be trimmed unless policy dictates, but standard practice is literal. User said "same format", so input might have spaces? I will NOT trim password to be safe, user might mean spaces are valid. But username/email definitely trim.
                ...
                <div class="w3-container w3-padding-large">
                    ...
                    <?php if (isset($success)): ?>
                        <div class="w3-panel w3-pale-green w3-border w3-round">
                            ...
                            <p><a href="<?php echo _route('login'); ?>" class="w3-button w3-blue w3-round">Aller à la page
                                    de
                                    connexion</a></p>
                        </div>
                    <?php endif; ?>
                        ...
                        <div class="w3-row-padding" style="margin:0 -8px;">
                            <div class="w3-half">
                                ...
                                <input class="w3-input w3-border w3-round w3-margin-bottom" type="text"
                                    name="first_name" required placeholder="Ex: Jean"
